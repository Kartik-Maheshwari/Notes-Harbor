...
const MainPage = () => {
  ...
  return (
    <div className="main-container grid grid-cols-1 md:grid-cols-2 md:gap-8">
      <div className="profile-section flex flex-col justify-center items-center md:flex-row md:justify-between md:items-center">
        <img
          src="path/to/profile-picture.jpg"
          alt="Profile Picture"
          className="profile-picture rounded-full h-16 w-16 border border-gray-300" // Ensure circular class is applied
        />
        <div className="profile-buttons flex gap-4 mt-4 md:mt-0"> <button className="profile-button px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300">
            Activity
          </button>
